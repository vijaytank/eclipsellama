...
/**
 * Handler for the "Review Code" action. Sends selected code to the chat with a
 * code review instruction.
 */
public class ReviewCodeHandler extends ExplainCodeHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			chatView.setContext(selectedText, "review");
