...
/**
 * AI-powered code completion for Java editor. Uses async completion with
		...
		try {
			...
			if (suggestion != null && !suggestion.isEmpty() && !suggestion.equals(prefix)) {
				...
				if (!suggestion.isEmpty()) {
					ICompletionProposal proposal = new CompletionProposal(suggestion, offset, 0, suggestion.length(),
							null, "🦙 " + truncate(suggestion, 50), null, "AI-generated completion");
