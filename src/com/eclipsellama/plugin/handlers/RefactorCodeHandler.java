...
/**
 * Handler for the "Refactor Code" action. Sends selected code to the chat with
 * a refactoring instruction.
 */
public class RefactorCodeHandler extends ExplainCodeHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			chatView.setContext(selectedText, "refactor");
